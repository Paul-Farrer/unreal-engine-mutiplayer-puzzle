...
#include "PlatformPuzzleGame/MovingPlatform.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	PLATFORMPUZZLEGAME_API UClass* Z_Construct_UClass_AMovingPlatform();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMovingPlatform_Statics::NewProp_TargetLocation_MetaData[] = {
		{ "Category", "MovingPlatform" },
		{ "Comment", "// Visualise a widget for the target location which allows the variable to be altered within the editor \n" },
		{ "MakeEditWidget", "TRUE" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
		{ "ToolTip", "Visualise a widget for the target location which allows the variable to be altered within the editor" },
	};
#endif
	...
	IMPLEMENT_CLASS(AMovingPlatform, 2682836064);
	template<> PLATFORMPUZZLEGAME_API UClass* StaticClass<AMovingPlatform>()
	{
		return AMovingPlatform::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMovingPlatform(Z_Construct_UClass_AMovingPlatform, &AMovingPlatform::StaticClass, TEXT("/Script/PlatformPuzzleGame"), TEXT("AMovingPlatform"), false, nullptr, nullptr, nullptr);
